...
const VECTORS: Record<IconName, string> = {
  ...
  run: /* play */ `<path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"/>`,
 ...
 * escaping is the one to write — and `run` is filled, since an outlined triangle
 * at twelve pixels reads as a gap rather than as a play button.
 */
export function iconUrl(name: IconName): string {
  const fill = name === "run" ? "black" : "none";
  const svg =
